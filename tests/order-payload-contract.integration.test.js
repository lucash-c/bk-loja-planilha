...
async function setupSchema() {
  ...
  await db.query('CREATE TABLE store_settings (id TEXT PRIMARY KEY, loja_id TEXT, delivery_enabled INTEGER, pickup_enabled INTEGER, dine_in_enabled INTEGER, is_open INTEGER)');
